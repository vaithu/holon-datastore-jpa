...
* The *DataTarget* _name_ is interpreted as the *JPA _entity_ name* (i.e. the simple _entity_ class name or the name specified using the `name` attribute of the `jakarta.persistence.Entity` annotation).
...
If the JPA _entity_ name is specified using the `name` attribute of the `jakarta.persistence.Entity` annotation, that name has to be used as `DataTarget` name.
...
The entity name used in persistence operations will be the entity class simple name or the name specified using the `name` attribute of the `jakarta.persistence.Entity` annotation, if available.
